...
public class UpdateMeetingValidatorTests
{
    private readonly UpdateMeetingValidator _validator;

    public UpdateMeetingValidatorTests()
    {
        _validator = new UpdateMeetingValidator();
    }

    private static UpdateMeetingDto CreateValidDto()
    {
